...
Auth::routes();
Route::get('/about', [\App\Http\Controllers\BlogPostController::class, 'about']);
Route::get('/blog', [\App\Http\Controllers\BlogPostController::class, 'index'])->name('welcome');
...
Route::delete('/blog/{blogPost}', [\App\Http\Controllers\BlogPostController::class, 'destroy'])->name('blogPost.destroy')->middleware('can:destroy,blogPost'); //deletes post from the database
//Route::delete('/blog/{bb}', [HomeController::class, 'destroyBb'])->name('bb.destroy');